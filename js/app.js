...
window.loadFeedItemsFromSupabase = loadFeedItemsFromSupabase;
window.syncFollowsFromServer = syncFollowsFromServer;
window._getCollectionsSync = _getCollectionsSync;
